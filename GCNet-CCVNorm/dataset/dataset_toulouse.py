...
class DatasetToulouse(Dataset):
    ...
    def __init__(self, datalist, output_size, mode, disp_scale=256, fix_random_seed=False):
        # Check arguments
        self.mode = mode
        ...
        # Get all data path
        self.left_data_path, self.right_data_path = get_train_datapath(datalist)
...
def get_train_datapath(folderlist):
