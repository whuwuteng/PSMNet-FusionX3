...
def load_vaihingen_evluation(folderlist, guideL, guideR,  savedisp, subfolder):
    ...
    return all_left_img, all_right_img, all_left_guide, all_right_guide, all_left_disp
