...
def get_config():
    ...
    cfg.workspace = '/work/scratch/tengw/Toulouse_AI4GEO2020_Model_echo/CCVNorm_05_tin_rsmprop' # Name of the workspace for an experiment
    ...
    cfg.pretrained = '/work/scratch/tengw/Toulouse_AI4GEO2020_Model_echo/CCVNorm_05_tin_rsmprop/ckpt/[ep-16]giter-4800.ckpt' # Set to None for not loading pretrained model
