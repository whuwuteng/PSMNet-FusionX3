...
def get_config():
    ...
    cfg.workspace = '/work/scratch/tengw/Toulouse_AI4GEO2020_Model_echo/CCVNorm_pattern_rsmprop' # Name of the workspace for an experiment
    ...
    cfg.pretrained = '/work/scratch/tengw/Toulouse_AI4GEO2020_Model_echo/CCVNorm_pattern_rsmprop/ckpt/[ep-30]giter-9001.ckpt' # Set to None for not loading pretrained model
