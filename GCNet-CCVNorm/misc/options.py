...
def get_config():
    ...
    cfg.workspace = '/work/OT/ai4geo/users/tengw/Toulouse_AI4GEO2020_Model_echo/CCVNorm0_01' # Name of the workspace for an experiment
    ...
    cfg.lr_scheduler_name = 'step_lr' # Set to None for not using learning rate decay, see `get_lr_scheduler`
    cfg.pretrained = None # Set to None for not loading pretrained model
    #cfg.pretrained = '/work/OT/ai4geo/users/tengw/Toulouse_AI4GEO2020_Model_echo/CCVNorm0_01/ckpt/[ep-38]giter-11600.ckpt' # Set to None for not loading pretrained model
