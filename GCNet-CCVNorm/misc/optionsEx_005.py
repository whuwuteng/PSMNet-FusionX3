...
def get_config():
    ...
    cfg.workspace = '/work/OT/ai4geo/users/tengw/Toulouse_AI4GEO2020_Model_echo/CCVNorm0_005' # Name of the workspace for an experiment
    ...
    cfg.guideL = 'guide0_005'
    cfg.guideR = 'guideR0_005'
    ...
    cfg.pretrained = '/work/OT/ai4geo/users/tengw/Toulouse_AI4GEO2020_Model_echo/CCVNorm0_005/ckpt/[ep-33]giter-9901.ckpt' # Set to None for not loading pretrained model
