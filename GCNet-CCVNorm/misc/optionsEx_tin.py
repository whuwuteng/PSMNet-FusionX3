...
def get_config():
    ...
    cfg.workspace = '/work/scratch/tengw/Toulouse_AI4GEO2020_Model_echo/CCVNorm_pattern_tin_rsmprop' # Name of the workspace for an experiment
    cfg.data= '/work/scratch/tengw/stereodense_training_select/Toulouse_AI4GEO2020-stereo_urban_guide/training' # Name of the data path for the training set
    cfg.trainpath = 'toulouse_ai4geo_trainlist_guide.txt'
    cfg.valpath = 'toulouse_ai4geo_vallist_guide.txt'
    cfg.guideL = 'TIN_pattern_new'
    cfg.guideR = 'TINR_pattern_new'
    ...
    cfg.pretrained = '/work/scratch/tengw/Toulouse_AI4GEO2020_Model_echo/CCVNorm_pattern_tin_rsmprop/ckpt/[ep-18]giter-5500.ckpt' # Set to None for not loading pretrained model
