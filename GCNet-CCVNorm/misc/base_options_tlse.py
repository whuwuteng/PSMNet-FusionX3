...
def get_config():
    ...
    cfg.workspace = '/work/OT/ai4geo/users/tengw/Toulouse_TlseMetro_Model_echo/CCVNorm_base' # Name of the workspace for an experiment
    cfg.data= '/work/OT/ai4geo/users/tengw/stereobenchmark_AI4GEO/Toulouse_TlseMetro-stereo_echo_new/training' # Name of the data path for the training set
    cfg.trainpath = 'toulouse_tlse_trainlist_ave.txt'
    cfg.valpath = 'toulouse_tlse_vallist_ave.txt'
    ...
    cfg.pretrained = '/work/OT/ai4geo/users/tengw/Toulouse_TlseMetro_Model_echo/CCVNorm_base/ckpt/[ep-24]giter-7100.ckpt' # Set to None for not loading pretrained model
    cfg.weight_only = False # if pretrained model loaded, load model weight only or optimizer as well
    cfg.start_epoch = 25 # Number of epochs for training
