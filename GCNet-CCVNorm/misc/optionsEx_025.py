...
def get_config():
    ...
    cfg.workspace = '/work/OT/ai4geo/users/tengw/Toulouse_AI4GEO2020_Model_echo/CCVNorm0_025' # Name of the workspace for an experiment
    ...
    cfg.optimizer_name = 'adam' # Optimizer, for more settings please refer to `get_optimizer` function in the below
    ...
    cfg.pretrained = '/work/OT/ai4geo/users/tengw/Toulouse_AI4GEO2020_Model_echo/CCVNorm0_025/ckpt/[ep-24]giter-7300.ckpt' # Set to None for not loading pretrained model
