...
# pytorch can use auto learning rate
# but there is no learning rate in the configuration
...
def main():
    ...
    parser = argparse.ArgumentParser(description='Sparse-Depth-Stereo training')
