...
def get_config():
    ...
    cfg.workspace = '/work/OT/ai4geo/users/tengw/Toulouse_TlseMetro_Model_echo/CCVNorm' # Name of the workspace for an experiment
    ...
    cfg.pretrained = '/work/OT/ai4geo/users/tengw/Toulouse_TlseMetro_Model_echo/CCVNorm/ckpt/[ep-14]giter-12200.ckpt' # Set to None for not loading pretrained model
    cfg.weight_only = False # if pretrained model loaded, load model weight only or optimizer as well
    cfg.start_epoch = 42 # Number of epochs for training
