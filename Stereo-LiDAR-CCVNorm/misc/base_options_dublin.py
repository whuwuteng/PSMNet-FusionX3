...
def get_config():
    ...
    cfg.workspace = '/work/OT/ai4geo/users/tengw/DublinCity_Model_echo/CCVNorm_base' # Name of the workspace for an experiment
    ...
    cfg.pretrained = '/work/OT/ai4geo/users/tengw/DublinCity_Model_echo/CCVNorm_base/ckpt/[ep-24]giter-6900.ckpt' # Set to None for not loading pretrained model
