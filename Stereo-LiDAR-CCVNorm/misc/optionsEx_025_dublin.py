...
def get_config():
    ...
    cfg.workspace = '/work/OT/ai4geo/users/tengw/DublinCity_Model_echo/CCVNorm0_025_rmsprop' # Name of the workspace for an experiment
    cfg.data= '/work/OT/ai4geo/users/tengw/stereobenchmark_AI4GEO/DublinCity-stereo_echo_new/training' # Name of the data path for the training set
    cfg.trainpath = 'dublin_trainlist.txt'
    cfg.valpath = 'dublin_vallist.txt'
    cfg.guideL = 'guide0_025'
    cfg.guideR = 'guideR0_025'
    ...
    cfg.pretrained = '/work/OT/ai4geo/users/tengw/DublinCity_Model_echo/CCVNorm0_025_rmsprop/ckpt/[ep-11]giter-3300.ckpt' # Set to None for not loading pretrained model
