...
def get_config():
    ...
    cfg.workspace = '/work/scratch/tengw/DublinCity_Model_echo/CCVNorm_pattern_rsmprop' # Name of the workspace for an experiment
    cfg.data= '/work/scratch/tengw/stereodense_training_select/training/DublinCity-stereo_echo_new/training' # Name of the data path for the training set
    cfg.trainpath = 'dublin_trainlist.txt'
    cfg.valpath = 'dublin_vallist.txt'
    cfg.guideL = 'guide_pattern'
    cfg.guideR = 'guideR_pattern'
    ...
    cfg.pretrained = '/work/scratch/tengw/DublinCity_Model_echo/CCVNorm_pattern_rsmprop/ckpt/[ep-31]giter-9301.ckpt' # Set to None for not loading pretrained model
...
def get_dataset(name):
    ...
    if name == 'kitti2017':
        ...
        train_dataset = DatasetToulouse(trainlist, train_output_size, 'train', cfg.guideL, cfg.guideR)
        val_dataset = DatasetToulouse(vallist, val_output_size, 'val', cfg.guideL, cfg.guideR)
    else:
