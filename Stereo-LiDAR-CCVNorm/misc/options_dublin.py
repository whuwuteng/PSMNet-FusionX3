...
def get_config():
    ...
    cfg.workspace = '/work/OT/ai4geo/users/tengw/DublinCity_Model_echo/CCVNorm0_01_new' # Name of the workspace for an experiment
    ...
    cfg.pretrained = '/work/OT/ai4geo/users/tengw/DublinCity_Model_echo/CCVNorm0_01_new/ckpt/[ep-26]giter-7900.ckpt' # Set to None for not loading pretrained model
