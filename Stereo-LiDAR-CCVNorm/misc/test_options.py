...
def get_config():
    ...
    cfg.workspace = '/work/OT/ai4geo/users/tengw/KITTI_Depth_Completion/test' # Name of the workspace for an experiment
    cfg.data= '/work/OT/ai4geo/users/tengw/KITTI_Depth_Completion' # Name of the data path for the training set
    ...
    cfg.pretrained = '/work/OT/ai4geo/users/tengw/KITTI_Depth_Completion/test/ckpt/[ep-00]giter-9000.ckpt' # Set to None for not loading pretrained model
