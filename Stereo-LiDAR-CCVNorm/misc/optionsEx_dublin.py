...
def get_config():
    ...
    cfg.workspace = '/work/scratch/tengw/DublinCity_Model_echo/CCVNorm_01_rsmprop' # Name of the workspace for an experiment
    ...
    cfg.guideL = 'guide0_01'
    cfg.guideR = 'guideR0_01'
    ...
    cfg.pretrained = '/work/scratch/tengw/DublinCity_Model_echo/CCVNorm_01_rsmprop/ckpt/[ep-35]giter-10900.ckpt' # Set to None for not loading pretrained model
