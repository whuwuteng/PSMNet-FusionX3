...
def get_config():
    ...
    cfg.workspace = '/work/scratch/tengw/DublinCity_Model_echo/CCVNorm_05_tin_rsmprop' # Name of the workspace for an experiment
    ...
    cfg.guideL = 'TIN0_05_new'
    cfg.guideR = 'TINR0_05_new'
    ...
    cfg.pretrained = '/work/scratch/tengw/DublinCity_Model_echo/CCVNorm_05_tin_rsmprop/ckpt/[ep-23]giter-6901.ckpt' # Set to None for not loading pretrained model
