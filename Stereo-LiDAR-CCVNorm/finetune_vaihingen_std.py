...
TrainImgLoader = torch.utils.data.DataLoader(
         DA.myImageFloderStd(all_left_img,all_right_img,all_left_disp, True, normalize = normalize, disp_scale=args.disp_scale), 
         batch_size= 4, shuffle= True, num_workers= 6, drop_last=False)

TestImgLoader = torch.utils.data.DataLoader(
         DA.myImageFloderStd(test_left_img,test_right_img,test_left_disp, False, normalize = normalize, disp_scale=args.disp_scale), 
         batch_size= 4, shuffle= False, num_workers= 4, drop_last=False)

model = PSMNetEx(args.maxdisp)
