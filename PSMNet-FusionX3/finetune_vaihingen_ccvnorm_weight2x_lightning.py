...
def main():
    ...
    train_output_size = (256, 384)
    val_output_size =  (256, 256) # NOTE: set to (256, 1216) if there is enough gpu memory

    data = DatasetToulouseWeight_lightning(args.train_datapath, train_output_size, args.val_datapath, val_output_size, args.guideL, args.guideR, normalize, train_batch_size = 2, val_batch_size = 1)
